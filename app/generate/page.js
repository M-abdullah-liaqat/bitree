...
function Page() {
  ...
  return (
    <div className="bg-[#e9c0e9]">
      <div className="Generate 2xl:w-[1532px] w-full justify-self-center min-h-screen bg-[#e9c0e9] px-8">
        <div className="min-h-screen w-[100%] justify-self-center grid grid-cols-2">
